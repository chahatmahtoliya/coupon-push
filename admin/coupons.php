                ...
                <div class="row g-4">
                    <div class="col-md-8">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label">Original Price <small class="text-muted">(optional – strikethrough price)</small></label>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label">Sale Price <small class="text-muted">(optional – discounted price)</small></label>
                                    <div class="input-group">
                                        <span class="input-group-text">₹</span>
