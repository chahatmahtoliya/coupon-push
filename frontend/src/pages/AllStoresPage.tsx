...
export function AllStoresPage() {
    ...
    useSEO({
        title: 'All Stores - CouponPush | Find Coupons by Brand',
        description: `Browse ${stores.length}+ stores and find the best coupons, promo codes, and discount offers at CouponPush.`,
            ...
            <section className="all-stores-hero-react">
                <div className="container">
                    ...
                    <div className="all-stores-hero-react-body">
                        <div>
                            <span className="all-stores-eyebrow-react">Store Directory</span>
