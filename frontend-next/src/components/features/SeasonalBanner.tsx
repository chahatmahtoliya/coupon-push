...
export function SeasonalBanner({ offer }: SeasonalBannerProps) {
    ...
    return (
        <>
            <section className="seasonal-banner cp-shell" style={gradientStyle}>
                    ...
                    <div className="seasonal-banner-content">
                        ...
                        <div className="seasonal-banner-header">
                            ...
                            <div className="seasonal-banner-meta">
                                ...
                                <Link href="/offers" className="seasonal-view-all">
                        ...
                        <div className="seasonal-coupons-wrapper">
                            <button type="button" className="seasonal-scroll-btn seasonal-scroll-left" aria-label="Previous seasonal coupons" onClick={scrollLeft}>
                            ...
                            <div className="seasonal-coupons-track" ref={scrollRef}>
                                {offer.coupons.map((coupon) => (
                                    <div key={coupon.id} className="seasonal-coupon-card">
                                        ...
                                        >
                                            {getCouponCtaLabel(coupon)}
                                        </button>
                                    </div>
                                ))}
                            </div>

                            <button type="button" className="seasonal-scroll-btn seasonal-scroll-right" aria-label="Next seasonal coupons" onClick={scrollRight}>
