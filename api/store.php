...
try {
    ...
    $storeData = [
        ...
        'name' => $store['name'],
        'slug' => $store['slug'],
        'h1_suffix' => $store['h1_suffix'] ?? null,
    ...
    $couponsData = array_map(function ($coupon) {
        return [
            ...
            'original_price' => isset($coupon['original_price']) && $coupon['original_price'] !== null ? (float)$coupon['original_price'] : null,
            'sale_price' => isset($coupon['sale_price']) && $coupon['sale_price'] !== null ? (float)$coupon['sale_price'] : null
        ];
    }, $coupons);
